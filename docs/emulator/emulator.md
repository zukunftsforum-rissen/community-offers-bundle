...
The PI Emulator simulates a hardware device (e.g. Raspberry Pi) and is used in **emulation mode** to test the full door workflow without real hardware.
...
| emulation  | Emulator acts as device |
|  | No polling, UI only |
